...
def parallel():
    ...
    with open ('./docker/data/'+target+'/temp/subdomain_parallel.log','a') as file:
        file.write('python3 ./scripts/parsers/parse_assetfinder.py '+target+' '+domain+'\n')
        file.write('python3 ./scripts/parsers/parse_subfinder.py '+target+' '+domain+'\n')
        file.write('python3 ./scripts/parsers/parse_sublist3r.py '+target+' '+domain+'\n')
